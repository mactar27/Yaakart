  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        <path d="M12 2c-4 0-7 3-7 6.5 0 1 .5 2.5 1 3-.5 0-1 .5-1 1s.5 1 1.5 1c0 0 .5 2.5 2 3.5-1 1-1 2-1 3 0 1 1 1 2 1s1.5-1 2.5-1 1.5 1 2.5 1 2 0 2-1-.5-2-1.5-3c1.5-1 2-3.5 2-3.5 1 0 1.5-.5 1.5-1s-.5-1-1-1c.5-.5 1-2 1-3C19 5 16 2 12 2z" />
      </svg>
    ),
  },
  {
